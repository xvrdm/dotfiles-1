...
## mutt
alias gmail="mutt -F ~/.mutt/muttrc.gmail"
...
alias bbcworld='get_iplayer --stream --type=liveradio 80157 --modes=hlsaaclow2 --player="mplayer -cache 128 -"'
...
getlog() { local file=~/logs/system/log-$(date +%Y%m%d-%H:%M).txt; sudo journalctl -b > "$file" && geany "$file"; }
